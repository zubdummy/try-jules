...
import React from 'react'; // useEffect might be needed if we re-introduce the editor instance workaround
import SelectionToolbar from './SelectionToolbar';
import { SlashCommand } from './SlashCommandExtension'; // Import the new custom extension
...
const RichTextEditor: React.FC<RichTextEditorProps> = ({ initialContent, onChange }) => {
  const editor = useEditor({
    extensions: [
      ...
      Underline,
      SlashCommand, // Add the custom SlashCommand extension
